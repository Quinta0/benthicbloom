...
export class LiveWallpaperManager {
    ...
    _start() {
        ...
        try {
            ...
            // set_state(PLAYING) alone always starts at native rate 1.0 —
            // without this, a configured custom speed only ever took effect
            // once the first EOS loop-restart seek ran.
            if (this._settings.get_double(SettingsKey.LIVE_WALLPAPER_PLAYBACK_RATE) !== 1.0)
